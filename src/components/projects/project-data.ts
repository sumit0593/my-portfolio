...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    techStack: ["Python", "JavaScript", "React 19", "Vite 8", "LangGraph", "Gemini API", "FastAPI", "SQLite", "SQLAlchemy", "Tailwind CSS 4", "Recharts 3"],
  ...
  },
  {
    ...
    techStack: ["Python", "FastAPI", "BM25", "RAGAS", "HuggingFace", "RRF", "Pinecone", "Gemini", "LangChain", "Streamlit"],
  ...
  },
  {
    ...
    techStack: ["Python", "Prompt Engineering", "NLP Pipelines", "LLM Orchestration", "Streamlit", "Gemini"],
  ...
  },
  {
    ...
    techStack: ["TypeScript", "Aceternity UI", "Next.js", "Tailwind CSS", "Three.js", "Framer Motion", "Gemini", "Pinecone"],
  ...
  },
  {
    ...
    category: "GenAI",
    categories: ["GenAI", "Frontend", "Backend", "Full Stack"],
    description: "An AI-powered community issue reporting platform that enables citizens to report hyperlocal municipal issues (potholes, water leaks, trash, etc.) with coordinates and images, auto-classify tickets with Google Gemini, view issues on a dark GIS map, and verify reports to initiate city dispatches.",
    techStack: ["TypeScript", "Next.js", "Prisma", "PostgreSQL", "PostGIS", "Gemini API", "GCP Cloud Run", "Docker", "Secret Manager", "Cloud Storage"],
    githubUrl: "https://github.com/sumit0593/Community-Hero---Hyperlocal-Problem-Solver",
    liveUrl: "https://community-hero-wlanslf4ba-uc.a.run.app/",
